        ...
        <div className={styles.loginCard}>
          ...
          <form onSubmit={handleSubmit} className={styles.loginForm}>
            ...
            <div className={styles.demoNotice}>
              <p>For demo purposes, use these emails to test different roles:</p>
              <ul>
                <li><strong>student@example.com</strong> - Student account</li>
                <li><strong>employer@example.com</strong> - Employer account</li>
                <li><strong>admin@example.com</strong> - Admin account</li>
              </ul>
